...
c        if(mod(kstep,1).eq.0) then
     ...
     $                              ,', T = ',time
      ...
      enddo
c work to be done here: extract the error out of ifout loop 
c     Tue Mar 22 22:13:35 CDT 2016
...
c
     ...
     $                          + uy(i,e)*sym1(i,1,1,e) )
            enddo
            call local_grad2_t(u,ur,us,u,N,e,dxm1,dytm1,tmp)
         endif
      enddo
c
      return
