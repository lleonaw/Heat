% Navier-Stokes solver - attempt 
%-----------------------------------------------------
function [te,rh,ru,rv,en]=ns(Nelx,N,No,dt)
%-----------------------------------------------------
%!resize
...
for e=1:Nelx; 
    ...
    dsavg(j,jp)=.5; dsavg(jp,j)=.5; dsavg(jp,jp)=.5; 
end;
